...
Этот документ фиксирует целевой пользовательский flow для будущего WPF MVP. Сейчас WPF-приложение является bootstrap-окном; описанное ниже не реализовано полностью.
