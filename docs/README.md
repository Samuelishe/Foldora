...
Localization foundation описан в `LOCALIZATION.md`: complete/enabled locales `ru`, `en`, `zh-Hans`, `de`, `es`, `fr`, `ja`, `pt-BR` и `ko`; смена языка не переводит сохранённые пользовательские menu data.
