...
Localization foundation описан в `LOCALIZATION.md`: сейчас complete/enabled locales только `ru` и `en`; смена языка не переводит сохранённые пользовательские menu data.
