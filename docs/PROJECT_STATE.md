...
Текущий фокус: ручная проверка legacy menu icons, no-console MenuHost launch и WPF save-triggered rebuild на Windows 11.
