...
Текущий фокус: WPF editor MVP следующего этапа - выбор/import `.ico`, добавление/удаление entries и icon preview без смешивания UI и Core logic.
